...
def add_sidebar():
    ...
    st.sidebar.write("Please connect this App to your Cytology Lab to help diagnose Breast Cancer from your tissue sample.")
...
def main() :  
    ...
    with st.container() :
        ...
        st.write("This App predicts using a Support Vector Machine Learning Model whether a Breast Mass is Benign or Malignant based on the measurements it receives from your Cytology Lab. You can also Update the measurements by hand using sliders in the sidebar.")
